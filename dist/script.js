...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/firstblock/style.scss");
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).on("click", ".wp-block-fox-theme-blocks-secondblock", function () {
  alert(true);
  console.log('dziala');
});
